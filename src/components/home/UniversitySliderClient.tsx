...
// Inline SVGs — eliminates ~30-40KB lucide-react from this chunk
const ChevronLeft = ({ className }: { className?: string }) => <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" width="20" height="20"><path d="m15 18-6-6 6-6"/></svg>
const ChevronRight = ({ className }: { className?: string }) => <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" width="20" height="20"><path d="m9 18 6-6-6-6"/></svg>
const MapPin = ({ className }: { className?: string }) => <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" width="16" height="16"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
const BookOpen = ({ className }: { className?: string }) => <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" width="20" height="20"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
const Eye = ({ className }: { className?: string }) => <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" width="20" height="20"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
const Star = ({ className }: { className?: string }) => <svg className={className} fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" width="20" height="20"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
const ChevronDown = ({ className }: { className?: string }) => <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" width="16" height="16"><path d="m6 9 6 6 6-6"/></svg>
const ChevronUp = ({ className }: { className?: string }) => <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" width="16" height="16"><path d="m18 15-6-6-6 6"/></svg>

// Lazy-load modals — they're only shown on user click, no need in initial bundle
const CompareForm = dynamic(() => import('../modals/CompareForm'))
const BrochureForm = dynamic(() => import('@/components/modals/UniversityForms').then(m => ({ default: m.BrochureForm })))
const FeeStructureForm = dynamic(() => import('@/components/modals/UniversityForms').then(m => ({ default: m.FeeStructureForm })))
const FormSuccessPopup = dynamic(() => import('@/components/common/FormSuccessPopup'))
...
export default function UniversitySliderClient({ universities }: { universities: University[] }) {
  ...
  // Defer Swiper CSS off the critical render path — only loads when component mounts
  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-ignore — swiper/css is a CSS file, no TS declarations needed
