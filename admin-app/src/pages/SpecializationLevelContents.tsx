      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs">
        ...
        <div className="flex items-center gap-2.5">
          {!isFormVisible && (
            ...
            >
              <Plus className="w-3.5 h-3.5 text-emerald-300" /> Add Content
            </button>
          )}
          <button
            onClick={fetchData}
            ...
            <table className="w-full text-left border-collapse text-xs">
              <thead>
                <tr className="bg-[#effaf2] border-b-2 border-[#c8ebd2] text-[#14532d] font-extrabold uppercase tracking-wider text-[11px]">
                  ...
                  <th className="py-3.5 px-5 text-[#14532d]">Title</th>
                  <th className="py-3.5 px-5 text-[#14532d]">Description</th>
