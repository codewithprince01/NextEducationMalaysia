      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/80 shadow-xs">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1 font-medium">
            Manage student reviews, university alumni ratings, and verified feedbacks.
          </p>
        </div>
        <div className="flex items-center gap-2.5">
          ...
          >
            <Plus className="w-4 h-4 text-emerald-300" /> Add Testimonial
          </button>
        </div>
      </div>
        ...
        <div className="p-4 border-b border-slate-200/80 flex flex-col sm:flex-row gap-3 justify-between items-center bg-slate-50/40">
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 text-xs font-medium bg-white border border-slate-200 rounded-xl focus:outline-hidden focus:ring-1 focus:ring-emerald-500 focus:border-emerald-600 transition-all"
            />
          </div>
          ...
          <table className="w-full text-left text-xs text-slate-600">
            <thead className="bg-[#effaf2] border-b-2 border-[#c8ebd2] text-[#14532d] font-extrabold uppercase tracking-wider text-[11px]">
              <tr>
                ...
                <th className="py-3.5 px-4 text-[#14532d]">Student Name</th>
                <th className="py-3.5 px-4 text-[#14532d]">University</th>
                <th className="py-3.5 px-4 text-[#14532d]">Program</th>
                <th className="py-3.5 px-4 text-[#14532d]">Rating</th>
                <th className="py-3.5 px-4 text-[#14532d]">Review</th>
              ...
              {loading ? (
                ...
                paginated.map((item, index) => (
                  <tr key={item.id} className="hover:bg-[#effaf2]/40 transition-colors">
                    ...
                    <td className="py-3.5 px-4 font-bold text-[#14532d]">{item.university_name || '-'}</td>
            ...
            <form onSubmit={handleSubmit} className="p-5 space-y-4">
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="px-4 py-2 text-xs font-bold text-slate-700 hover:bg-slate-100 rounded-xl transition-colors cursor-pointer border border-slate-200"
                >
                  Cancel
                </button>
                <button
