  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs">
        ...
        <div className="flex items-center gap-2.5">
          {!isFormVisible && (
            ...
            >
              <Plus className="w-3.5 h-3.5 text-emerald-300" /> Add Level
            </button>
          )}
      ...
      <div className="bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden">
        <div
          className="px-6 py-4 border-b border-stone-200/90 flex items-center justify-between bg-[#faf8f4] cursor-pointer select-none"
          onClick={() => setIsFormVisible(!isFormVisible)}
        >
          <h3 className="font-extrabold text-stone-900 text-sm flex items-center gap-2 font-serif">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="flex items-center justify-start gap-3 pt-3">
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-stone-100 hover:bg-stone-200 text-stone-700 font-bold text-xs transition-colors cursor-pointer"
              >
              ...
              <button
                type="submit"
                disabled={submitting}
                className="flex items-center gap-1.5 px-6 py-2.5 rounded-xl bg-[#14532d] hover:bg-[#0f3e21] text-white font-bold text-xs shadow-xs disabled:opacity-50 transition-all cursor-pointer"
              >
                {submitting ? <Loader2 className="w-3.5 h-3.5 animate-spin text-emerald-300" /> : <Save className="w-3.5 h-3.5" />}
                <span>{editingId ? 'Update Level' : 'Save Record'}</span>
              </button>
            </div>
          </form>
        )}
            ...
            <table className="w-full text-left border-collapse text-xs">
              <thead>
                <tr className="bg-[#effaf2] border-b-2 border-[#c8ebd2] text-[#14532d] font-extrabold uppercase tracking-wider text-[11px]">
                  <th className="py-3.5 px-5 text-emerald-700">Sr. No.</th>
                  <th className="py-3.5 px-5 text-[#14532d]">Level</th>
                  {!paramSpecId && <th className="py-3.5 px-5 text-[#14532d]">Specialization</th>}
                  <th className="py-3.5 px-5 text-[#14532d]">Duration</th>
                  <th className="py-3.5 px-5 text-[#14532d]">Tuition Fees</th>
                  <th className="py-3.5 px-5 text-[#14532d]">Intake</th>
                  <th className="py-3.5 px-5 text-[#14532d]">Accreditation</th>
                  <th className="py-3.5 px-5 text-[#14532d]">SEO</th>
                  <th className="py-3.5 px-5 text-right text-[#14532d]">Action</th>
                </tr>
              </thead>
